          ...
          child: SettingsSection(
            children: [
              SettingsToggleTile(
                ...
                subtitle: tr(
                    'Amaran azan dan peringatan', 'Azan and reminder alerts'),
              ...
              ListTile(
                ...
                subtitle: Text(
                  _soundProfileLabel(
                      controller, controller.globalAzanSoundProfile),
                ),
              ...
              ListTile(
                ...
                subtitle: Text(
                    tr('Mainkan bunyi yang dipilih', 'Play selected sound')),
                enabled: controller.notifyEnabled,
                onTap: controller.notifyEnabled
                    ? () {
                      ...
                      .map(
                        (name) => FilterChip(
                          ...
                          onSelected: controller.notifyEnabled
                              ? (v) =>
                                  controller.setPrayerNotifyEnabled(name, v)
                              : null,
                        ),
                      )
                      .toList(),
